...
for a1, a2, a3, a4 in product([0, 1], repeat=4):
    ...
    t = [(a1, a2, 0,  0),
         (1,  0,  a3, 0),
         (1,  0,  1,  a4)]  # здесь значения столбцов, пустоты меняете на переменные a1, a2, a3, a4 - меняете под себя
    ...
    for p in permutations('xyzw'):
        ...
        if [f(**dict(zip(p,r))) for r in t]==[0,0,0]:  # здесь [0,0,0] - это значения функции из столбца F - меняете под себя
            print(*p, sep='')
